...
async fn test_load_patterns() -> Result<()> {
    ...
    let constant_controller =
        LoadController::new(LoadPattern::Constant, Some(100), 10, Duration::from_secs(5));
    ...
    let ramp_controller =
        LoadController::new(LoadPattern::RampUp, Some(100), 10, Duration::from_secs(10));
